...
def analisador_sentimentos(nome_produto, modelo="gemini-2.0-flash"):
    prompt_sistema = f"""
    ...
    prompt_usuario = carrega(f"curso_gemini//dados//avaliacoes-{nome_produto}.txt")
    ...
    try:
        ...
        salva(f"curso_gemini//dados//resposta-{nome_produto}.txt", texto_resposta)
